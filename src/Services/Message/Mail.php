...
use Thotam\ThotamGmail\Services\Traits\Mailable;
...
{
    use Mailable {
        Mailable::__construct as private __mConstruct;
    }
     ...
     * @return void
     */
    protected function getThread(string $threadId)
    {
        return $this->service->users_threads->get('me', $threadId);
    }
